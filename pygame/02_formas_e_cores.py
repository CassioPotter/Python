import pygame #importa a biblioteca pygame inteira

# Definindo as cores
PRETO = (0, 0, 0) #ausencia de todas as cores
BRANCO = (255, 255, 255) #todas as cores no maximo
VERMELHO = (255, 0, 0)
VERDE = (0, 255, 0)
AZUL = (0, 0, 255)
...
janela = pygame.display.set_mode((500, 400)) #cria uma janela como uma tupla de 500px por 400px  
pygame.display.set_caption('Figuras e Texto') #texto da janela

# Preenchendo o fundo da janela com a cor branca
janela.fill(BRANCO) #cobre a superficie da janela de branco

# Trabalhando com texto
fonte = pygame.font.Font(None, 48) #nome da fonte seguido pelo seu tamanho
texto = fonte.render('Olá, mundo!', True, BRANCO, AZUL) #texto , cor da fonte, cor do fundo
janela.blit(texto, [30, 150]) #janela do texto
